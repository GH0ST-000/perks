    ...
    const translations = {
        ka: {
            ...
            offers: {
                ...
                subtitle: 'აღმოაჩინე საუკეთესო ბენეფიტები',
                seeAll: 'ყველას ნახვა',
                premium: 'პრემიუმ',
            ...
            footer: {
                desc: 'ბენეფიტების პლატფორმა, რომელიც აკავშირებს კომპანიებს ექსკლუზიურ შეთავაზებებთან ქვეყნის საუკეთესო პარტნიორებთან.',
                platform: 'პლატფორმა',
                resources: 'რესურსები',
                contact: 'კონტაქტი',
                blog: 'ბლოგი',
