    ...
    <main class="bg-gray-900 text-white min-h-screen">
        ...
        <section class="py-20 px-4">
            <div class="max-w-7xl mx-auto text-center">
                <h1 class="text-5xl md:text-6xl font-bold mb-6">შემოუერთდი ჩვენს გუნდს</h1>
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">ჩვენ ვქმნით საუკეთესო გამოცდილებას დასაქმებულებისთვის.</p>
            </div>
        </section>
        ...
        <section class="py-12 px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-gray-700">
                    <h2 class="text-3xl font-bold mb-4 md:mb-0">მიმდინარე ვაკანსიები</h2>
                        ...
                        <form method="GET" action="{{ route('vacancies.index') }}" class="w-full md:w-auto">
                            <div class="relative">
                                <select
                                    ...
                                    class="bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-2 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent cursor-pointer"
                                >
                        ...
                        @foreach($vacancies as $vacancy)
                            <div class="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                    <!-- Left Side: Job Info -->
                                    <div class="flex-1">
                                        <h3 class="text-xl font-bold text-white mb-3">{{ $vacancy->title }}</h3>
                ...
                @else
                    <div class="text-center py-20 bg-gray-800 rounded-lg border border-gray-700">
                        <div class="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-400">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-bold text-white mb-2">ვაკანსიები არ მოიძებნა</h3>
                        <p class="text-gray-400 mb-8">სცადეთ სხვა დეპარტამენტი</p>
                    </div>
                @endif
            </div>
        </section>
    ...
    <x-modal name="application-modal" maxWidth="2xl">
        <div class="bg-gray-800 p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-white" id="modal-title">განაცხადის გაგზავნა</h2>
                <button
            ...
            <form id="application-form" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <!-- Name and Surname -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-300 mb-2">სახელი, გვარი</label>
                    <input
                        type="text"
                        id="name"
                        name="name"
                        required
                        class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <!-- Email -->
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-300 mb-2">ელ-ფოსტა</label>
                    <input
                        type="email"
                        id="email"
                        name="email"
                ...
                <!-- CV Upload -->
                <div>
                    <label for="cv" class="block text-sm font-medium text-gray-300 mb-2">ატვირთეთ CV</label>
                    <div class="relative">
                        <input
                            type="file"
                            id="cv"
                        ...
                        <label
                            for="cv"
                            class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-600 rounded-lg cursor-pointer bg-gray-700 hover:bg-gray-600 hover:border-gray-500 transition-colors"
                        >
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                <svg class="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                                </svg>
                                <p class="mb-2 text-sm text-gray-400" id="file-label">
                ...
                <div>
                    <label for="cover_letter" class="block text-sm font-medium text-gray-300 mb-2">დამატებითი ინფორმაცია (არასავალდებულო)</label>
                    <textarea
                        id="cover_letter"
                        name="cover_letter"
                        rows="4"
                ...
                <!-- Phone (Optional) -->
                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-300 mb-2">ტელეფონი (არასავალდებულო)</label>
                    <input
                        type="tel"
                        id="phone"
                        name="phone"
